...
<<<<<<< HEAD
Мы активно работаем над адаптивной вёрсткой с помощью медиавыражений `@media`, технологий `Flex Layout` и `Grid Layout` для написания стилей CSS. При такой вёрстке веб-дизайн динамично подстраивается под размер экрана пользователя, в нашем случае - мобильного устройства, потому что для основной аудитории нашего приложения смартфоны уже стали неотъемлемой частью жизни!📱
=======
Мы активно работаем над адаптивной версткой, совсем скоро наше приложение будет классно смотеться в телефоне!📱
>>>>>>> 8cf9ebfd1f596803d95f9dde6c31da9b73cb0146
