...
export const cardsForArticle = [
  {
    id: 1,
    image: article,
    title: 'Стрит-арт: теория и практика обживания уличной среды',
    author: 'Дмитрий Голынко-Вольфсон',
  },
  {
    id: 2,
    image: articleTwo,
    title: 'как модные дома вдохновляются уличным искусством',
    author: 'Ирина Костарева',
  },
  {
    id: 3,
    image: articleThree,
    title: 'парк скульптур на виноградниках в Калифорнии',
    author: 'Саша Маскалева',
  },
];
...
export const cardsForInterview = [
  {
    ...
    image: interview,
    title:
      'Егор Кальдиков «Пинать мяч, кататься на скейтборде или быть гангстером»',
    author: 'Богдан Майских',
  },
  {
    id: 2,
    image: interviewTwo,
    title: 'Даниэль Дхерс «первый, но точно не последний»',
    author: 'Рауль Генрих',
  },
  {
    id: 3,
    image: interviewThree,
    title: 'ТОНИ ХОУК «экстрим к в крови с самого детства»',
    author: 'Карина Гольман',
  },
];
...
export const cardsForAdvice = [
  {
    id: 1,
    image: advice,
    title: '10 лайфаков как встать на СКЕЙТ от тренера Александра Терьнова',
    author: 'Саша Черных',
  },
  {
    id: 2,
    image: adviceTwo,
    title:
      'Топ 5 парк кроссовок для паркура от чемпиона россии 2024 Егора емельянова ',
    author: 'Рауль Генрих',
  },
  {
    id: 3,
    image: adviceThree,
    title:
      'Гриша янов о лучших новинках BMX в 2024 году. Как съекономить на покупке.',
    author: 'Карина Гольман',
  },
];
...
export const playgroundAddresses = [
  {
    ...
    address: 'г. Ногинск, ул. Леснова, 2',
  },
  {
    id: 2,
    region: 'г. Москва',
    address: 'г. Москва, Нескучный сад',
  },
  {
    id: 3,
    region: 'Московская обл.',
    address: 'г. красногорск, жилой комплекс Арт',
  },
  {
    id: 4,
    region: 'Тульская обл.',
    address:
      'Тульская область, Советский территориальный округ, Центральный парк культуры и отдыха им. Белоусова',
  },
  {
    id: 5,
    region: 'ЯРОСЛАВСКАЯ обл.',
    address: 'ЯРОСЛАВСКАЯ ОБЛ., ул. Чкалова, д.54а',
  },
  {
    id: 6,
    region: 'Ростовская обл.',
    address: 'г. рОСТОВ, Ярославское шоссе, д.59',
  },
  {
    id: 7,
    region: 'ЯРОСЛАВСКАЯ обл.',
    address: 'ЯРОСЛАВСКАЯ ОБЛ., парк юбилейный ',
  },
  {
    id: 8,
    region: 'РЕСП. ТАТАРСТАН',
    address: 'РЕСПУБЛИКА ТАТАРСТАН, УЛ. Подлужная 67',
  },
  {
    id: 9,
    region: 'РЕСП. ТАТАРСТАН',
    address: 'РЕСПУБЛИКА ТАТАРСТАН,  пр-т химиков 76 Б',
  },
  {
    id: 10,
    region: 'РЕСП. ТАТАРСТАН',
    address: 'РЕСПУБЛИКА ТАТАРСТАН, Ул. Мурадьяна 6',
  },
  {
    id: 11,
    region: 'РЕСП. ТАТАРСТАН',
    address: 'РЕСПУБЛИКА ТАТАРСТАН, казань. ул. Сыртлановой 5',
  },
  {
    id: 12,
    region: 'РЕСП. ТАТАРСТАН',
    address: 'РЕСПУБЛИКА ТАТАРСТАН, ул. им Джалиля',
  },
  {
    id: 13,
    region: 'Саратовская обл.',
    address: 'Саратов, астраханская 87 б',
  },
  {
    id: 14,
    region: 'Саратовская обл.',
    address: 'САРАТОВ, Весенний проезд, 8',
  },
  {
    id: 15,
    region: 'Саратовская обл.',
    address: 'Саратов,  волжский район',
  },
  {
    id: 16,
    region: 'Кемеровская обл.',
    address: 'Кемеровская обл., Весенняя площадь',
  },
  {
    id: 17,
    region: 'Кемеровская обл.',
    address: 'Кемеровская обл., Парк им. Гагарина',
  },
  {
    id: 18,
    region: 'Кемеровская обл.',
    address: 'Новокузнецк, Новоильинский район',
  },
];
